...
import {  IoBicycleOutline, IoCalendarOutline, IoCheckboxOutline, IoCompassOutline, IoListOutline, IoPerson, IoPersonOutline } from 'react-icons/io5';
           ...
           <div>
             <div className="-mx-6 px-6 py-4">
               <Link href="#" title="home">
                 <Image
                   src={"https://tailus.io/sources/blocks/stats-cards/preview/images/first_user.webp"}
                   width={150}
                   height={150}
                   className="w-32"
                   alt="tailus logo"
